      ...
      <div className="grid grid-cols-12 grid-flow-row md:grid-flow-row">
        ...
        <div className="col-span-1 flex justify-center items-end pr-2">
          <button
            ...
            className="fixed shadow-2xl ring-1 ring-gray-900/10 bg-gray-700 hover:bg-gray-500 text-white p-2 rounded-full transition"
          >
            <FaArrowUp />
          </button>
        </div>
...

{
  /* <div className="bg-black py-4 relative flex justify-center items-center">
        ...
        <button
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          className="absolute right-5 bottom-8 shadow-2xl ring-1 ring-gray-900/10 bg-gray-700 hover:bg-gray-500 text-white p-2 rounded-full transition"
        >
          <FaArrowUp />
        </button>
      </div> */
