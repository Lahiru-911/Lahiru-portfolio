  ...
  return (
    <div className="w-full bg-black font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-16 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-gray-300 text-base md:text-lg max-w-2xl italic">
          A comprehensive overview of the key milestones in my career and
          education journey. From my academic foundation to my professional
          growth, this timeline highlights the pivotal moments that have shaped
          both my learning and career success.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
